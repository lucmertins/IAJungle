...
public class TabuleiroTest {
    ...
    public void testMove() {
        assertEquals(Tabuleiro.Posicao.A1, Tabuleiro.Posicao.posicao(0, 0));
        assertEquals(Tabuleiro.Posicao.A2, Tabuleiro.Posicao.posicao(0, 1));
        assertEquals(Tabuleiro.Posicao.B1, Tabuleiro.Posicao.posicao(1, 0));
        assertEquals(Tabuleiro.Posicao.D4, Tabuleiro.Posicao.posicao(3,3));
        assertEquals(Tabuleiro.Posicao.G7, Tabuleiro.Posicao.posicao(6, 6));
    }
    ...
    public void testPosY() {
        assertEquals(0, Tabuleiro.Posicao.posY(Tabuleiro.Posicao.A1));
        assertEquals(1, Tabuleiro.Posicao.posY(Tabuleiro.Posicao.A2));
        assertEquals(0, Tabuleiro.Posicao.posY(Tabuleiro.Posicao.B1));
        assertEquals(3, Tabuleiro.Posicao.posY(Tabuleiro.Posicao.D4));
        assertEquals(6, Tabuleiro.Posicao.posY(Tabuleiro.Posicao.G7));
